(function(w, d) {
    ...
    ! function(eY, eZ, e_, fa, fb, fc) {
        ...
        function fe(fh, fi, fj, fk) {
            return fi && eZ.getElementById(fi) || (fk = eZ.createElement(fh || "SCRIPT"), fi && (fk.id = fi), fj && (fk.onload = fj), eZ.head.appendChild(fk)), fk || {}
        }
        fc = /p/.test(eZ.readyState), eY.addEventListener("on" + e_ in eY ? e_ : "load", (function() {
            for (fc = 1; fb[0];) fd(fb.shift(), fb.shift())
        })), fd._ = fe, eY.defer = fd, eY.deferscript = function(fl, fm, fn, fo) {
            fd((function() {
                fe("", fm, fo).src = fl
            }), fn)
        }
    ...
    zaraz.__zcl.track = !0;
    d.addEventListener("visibilitychange", (cl => {
        zaraz._c({
    ...
    zaraz._p({
        ...
        "f": [
            ["https://stats.g.doubleclick.net/g/collect?t=dc&aip=1&_r=3&v=1&_v=j86&tid=G-SEKJ4E9T4H&cid=07cbbc3c-6082-4d8e-b6c5-2ad8f980d2a5&_u=KGDAAEADQAAAAC%7E&z=1691677443", {}]
        ]
    })
})(window, document);